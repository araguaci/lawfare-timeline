...
Pesquisar e identificar assuntos relevantes relacionados à **crise diplomática Brasil-EUA, relações internacionais, escândalos de corrupção, mau uso de verba pública e vexames recorrentes do atual governo brasileiro** que ocorreram **após 17/11/2025**, retornando um JSON estruturado com:
