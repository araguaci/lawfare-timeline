...
def generate_connections_section(connections: List, entry_id: str) -> str:
    ...
    for conn_id in connections:
        # Remove prefixo "id_" se existir
        conn_id_clean = conn_id.replace("id_", "").replace("_", "")
        section += f"- [Entrada {conn_id_clean}](/timeline/entries/{conn_id_clean})\n"
