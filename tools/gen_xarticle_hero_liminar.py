#!/usr/bin/env python3
"""Hero 1024x600 px para share card X Articles (tema LAWFARE)."""
...
OUT = os.path.join(ROOT, "artigos", "anatomia-liminar-monocratica-stf-xarticle-hero.png")
...
def main() -> None:
    ...
    title = "Liminar monocrática"
    sub = "STF · poder sem controle"
    seal = "LAWFARE · X Article"

    ft = _font(52, bold=True)
    fs = _font(30, bold=False)
    ...
    draw.text((80, y + 12), sub, fill=SUB_RGB, font=fs)
