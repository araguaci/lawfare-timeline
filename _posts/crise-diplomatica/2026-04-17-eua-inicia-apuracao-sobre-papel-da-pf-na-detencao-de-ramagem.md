---
title: "EUA iniciam apuração interna sobre papel da PF na detenção de Ramagem"
description: "Autoridades norte-americanas abrem processo formal para apurar se a PF brasileira tentou usar o ICE como mecanismo alternativo à extradição formal, contornando o Departamento de Estado."
date: 2026-04-17T12:00:00.000Z
image:
  path: "/assets/solid/magnifying-glass.svg"
...
A abertura de apuração formal pelos EUA marca a transição do episódio Ramagem de falha operacional para crise diplomática estruturada. Pela primeira vez no corpus do lawfare-timeline, uma agência estrangeira investiga formalmente a conduta de uma agência brasileira em território americano. O desfecho — expulsão do Delegado Marcelo Ivo três dias depois (ver [ID 149](/posts/delegado-marcelo-ivo-expulso-dos-eua-persona-non-grata/)) — indica que a apuração não foi lenta: as autoridades americanas já tinham resposta pronta.

## Referências

- [Estado de Minas](https://www.em.com.br/internacional/eua-apuram-pf-ramagem-ice) — Cobertura do início da apuração formal americana
- [Gazeta do Povo](https://www.gazetadopovo.com.br/republica/eua-investigam-pf-ramagem-deportacao-extradição) — Análise das dimensões jurídicas internacionais
