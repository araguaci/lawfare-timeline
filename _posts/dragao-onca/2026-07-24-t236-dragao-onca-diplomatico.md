...
tags: ["dragao-onca", "2026", "brasil-federal", "p04b", "p05", "p08", "p09", "p11"]
categories: dragao-onca
timeline_id: 236
status: confirmed
---

# O Dragão e a Onça — Capítulo 9: Braço Diplomático (registro federal Brasil-China, 2025-2026)

**Data:**  | **ID:** 236 | **Status:** confirmed
...
Falta posição formal do Itamaraty sobre o bloco de minerais críticos do G7/EUA (id_1714, id_1716) e detalhamento de obrigações assumidas na WAICO (id_1718). PL 2.780/2024 segue pendente de votação no Senado (id_1712) — sem marco legal, o Brasil negocia minerais críticos ad hoc, evento a evento.

## 🔍 Análise

ev-inference: o capítulo documenta um padrão de alinhamento assimétrico duplo em nível federal — o Brasil integra simultaneamente o bloco de governança de IA liderado pela China (WAICO, id_1718) e observa a transferência de seu principal ativo de terras raras para controle americano (id_1715), sem que nenhum dos dois movimentos resulte de estratégia nacional coordenada de captura de valor. É a versão federal do padrão 'soberania na conta do governador' identificado nos capítulos estaduais (Goiás/Caiado, Pará/Barbalho, Amazonas/Wilson Lima, Minas Gerais/Zema): aqui a conta cai sobre o Itamaraty e o Executivo federal, que negociam frameworks amplos (WAICO, memorandos, cúpulas) enquanto o valor concreto do ativo estratégico (Serra Verde) migra para fora do país sem contrapartida nacional identificada.

### Links para Pesquisa

- [🤖 Pesquisar com Perplexity](https://www.perplexity.ai/search?q=O%20Drag%C3%A3o%20e%20a%20On%C3%A7a%20%E2%80%94%20Cap%C3%ADtulo%209%3A%20Bra%C3%A7o%20Diplom%C3%A1tico%20%28registro%20federal%20Brasil-China%2C%202025-2026%29)
- [🌐 Buscar no Google](https://www.google.com/search?q=O%20Drag%C3%A3o%20e%20a%20On%C3%A7a%20%E2%80%94%20Cap%C3%ADtulo%209%3A%20Bra%C3%A7o%20Diplom%C3%A1tico%20%28registro%20federal%20Brasil-China%2C%202025-2026%29)
- [📖 Buscar na Wikipedia](https://pt.wikipedia.org/w/index.php?search=O%20Drag%C3%A3o%20e%20a%20On%C3%A7a%20%E2%80%94%20Cap%C3%ADtulo%209%3A%20Bra%C3%A7o%20Diplom%C3%A1tico%20%28registro%20federal%20Brasil-China%2C%202025-2026%29)
