...
# 💸 Olimpíadas de Paris: R$ 235 mil em viagem de 4 dias — comitiva de 220 pessoas, FAB, hotel Taj Palace
...
**Categoria:** Extravagância / Viagens internacionais  
**Valor Estimado:** R$ 4.500.000+ (comitiva total) / R$ 235.000 (equipe Janja Paris)  
**Órgão:** Presidência da República / FAB  
**Atores:** Luiz Inácio Lula da Silva, Rosângela da Silva (Janja)  
**Status:** TCU arquivou representação  
**Verificado:** sim
...
O arquivamento pelo TCU da representação sobre Paris (setembro 2024) antes de qualquer instrução contraditória é dado relevante para o padrão P07 (controle capturado). A estrutura formal (Decreto de designação de Janja publicado em DOU) foi usada retroativamente para legalizar a presença — demonstração do ciclo documentar-depois-de-ocorrer.
...
- Revista Oeste, 21/05/2025
- Aos Fatos, 12/12/2024
