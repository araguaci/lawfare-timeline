...
# 💸 Desfile Janja em Paris: R$ 344 mil pela Apex para evento com Brigitte Macron — Café de l'Homme, Torre Eiffel
...
**Categoria:** Extravagância / Evento / Viagem internacional  
**Valor Estimado:** R$ 344.462 (Apex evento) / R$ 2.100.000 (missão total França)  
**Órgão:** Apex-Brasil / Ministério de Desenvolvimento, Indústria, Comércio e Serviços  
**Atores:** Rosângela da Silva (Janja), Geraldo Alckmin, Apex-Brasil, Abest  
**Status:** Documentado  
**Verificado:** sim
...
O uso da Apex como canal de financiamento é estruturalmente idêntico ao padrão do Janjapalooza: o custo não é contabilizado na rubrica direta da Presidência, mas em agência vinculada a outro ministério. A ação ocorreu via convênio com a Abest (associação privada), adicionando camada de opacidade. Ação judicial em curso na 9ª Vara Cível Federal do DF pede anulação dos atos que autorizaram despesas com viagens da primeira-dama.
...
- Gazeta do Povo, 17/11/2025
- Requerimento dep. Gustavo Gayer (PL-GO)
- Portal da Transparência — viagens (até set/2025)
