...
image:
  path: "/assets/img/estudos/p11-expandido-loop-extracao-perpetua-xarticle-hero.webp"
  alt: "Ouroboros formado por cédulas de dinheiro envolvendo skylines industriais que se degradam em favelas — loop de extração perpétua"
  prompt: "An ouroboros — a serpent devouring its own tail — formed entirely from layered currency banknotes and financial bond documents, coiled in a perfect circle. Inside the loop: on one side the silhouette of a modern industrial skyline; on the opposite side the same skyline deteriorated into informal housing. The currency-serpent glows with faint gold and amber internal light against a deep black background. Symbolic and surreal. Macro photography aesthetic. Editorial."
...
- [Padrões Sistêmicos — P1 a P11](/posts/padroes-sistemicos/)
- [Geocorrupção — Mapa Geográfico da Captura](/posts/geocorrupcao-mapa-geografico-captura-institucional-brasil/)
