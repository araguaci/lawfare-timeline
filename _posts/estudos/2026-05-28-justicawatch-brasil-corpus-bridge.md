...
description: Ponte T-156 — observatório de decisões judiciais de alto impacto (2005–2025); HC, progressões, nulidades e alertas sistêmicos com fontes primárias.
...
| --- | ---: | --- |
| HC traficantes STJ | 9.166 | 2024 — ~50% de todos os HCs do tribunal |
...
| 2023 | STF | Anulação 695 kg cocaína | Nulidade de prova |
| 2024 | STJ | 9.166 HC a traficantes em 1 ano | Levantamento Seif |
...
| 🔴 Alto | **Tráfico privilegiado desfigurado** — 200–700 kg como "primário" |
...
- Schema JSON: `_data/justicawatch/justicawatch-brasil.json`
