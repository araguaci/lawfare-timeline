---
title: "Geocorrupção — O Mapa Geográfico da Captura Institucional: onde o Estado é mais poroso e por quê"
description: "A corrupção sistêmica no Brasil não se distribui uniformemente. Ela se concentra em nós geográficos: municípios com fundo a fundo, estados com TCEs capturados, fronteiras com fluxo de narcotráfico, metrópoles com fintechs autorizadas. Um mapeamento de como o território determina a intensidade da captura."
date: 2026-05-13T16:00:00.000Z
image:
  path: "/assets/img/estudos/geocorrupcao-frontmatter-hero.webp"
  alt: "Mapa topográfico noturno do Brasil com rios de luz âmbar marcando os fluxos de corrupção pelo território"
  prompt: "Aerial view of a stylized topographic relief map of Brazil seen from above at night. Rivers of glowing amber and deep red light flow from border regions and state capitals, converging at São Paulo and Rio de Janeiro. The rest of the country is dark blue-black with faint cartographic contour lines. The effect resembles satellite thermal imaging. Editorial data-journalism aesthetic. Beautiful but ominous. No text, no labels."
