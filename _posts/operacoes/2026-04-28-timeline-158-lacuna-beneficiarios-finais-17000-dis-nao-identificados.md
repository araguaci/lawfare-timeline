---
title: "Lacuna investigativa — Beneficiários finais das 17.000 DIs não identificados publicamente"
description: "As notas oficiais e fontes de imprensa mencionam 'importadores' como categoria de investigados, mas nenhum importador ou empresário é identificado pelo nome. O sigilo investigativo está mantido para os beneficiários do lado privado. Padrão histórico: quando os beneficiários finais são de alto perfil, o caso frequentemente para neste nível."
